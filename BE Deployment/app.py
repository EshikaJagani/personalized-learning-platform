...
# @app.route('/resources', methods=['POST', 'OPTIONS'])
def get_resources():

    # adding this since i added options method
...
if __name__ == '__main__':
    # app.run(host='0.0.0.0', port=8000, ssl_context=('/home/vmadmin2/certs/cert.pem', '/home/vmadmin2/certs/key.pem'))
    # app.run(host='0.0.0.0', port=8000, ssl_context=('../certs/cert.pem', '../certs/key.pem'))
